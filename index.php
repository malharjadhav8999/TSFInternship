  ...
  ?>
	...
	<!-- About Us section -->
		...
		<br>
			...
			<p class="About-us">Sparks Bank is a internship project done by Malhar Jadhav for TSF(The Sparks Foundation) as a web development Project .</p>
			<p class="Features">Softwares used </p>
			<p class="SW"> Front End - HTML , CSS ,Bootstrap<br> Back End - PHP <br> Database - MySQL</p>
	
      <footer class="text-center mt-5 py-2">
        <p>An Internship Project For TSF GRIP by Malhar Jadhav </p>
      </footer>
